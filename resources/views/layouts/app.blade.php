        ...
        <div class="header">
            <div class="menu-bar fixed-top shadow-sm">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{ url('/') }}">NGC <span class="font-italic full">->Next Gen
                            Computex</span></a>
                            ...
                            <div class="d-flex ml-5" role="group" aria-label="Basic example">
                                @guest
                                    @if (Route::has('login'))
                                        <li class="nav-item m-1">
                                            <a class="btn btn-sm bttn btn-outline-dark" role="button"
                                ...
                                @else
                                    <li class="nav-item dropdown">
                                        <a id="navbarDropdown" class="nav-link dropdown-toggle m-1" href="#"
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-3 col-sm-6 pb-2">
                        ...
                        <ul class="list-unstyled" style="font-size:13px;">
                            <li><i class="fa-brands fa-cc-mastercard" style="font-size:20px;"></i>&emsp;<a
                                    href="#">MASTER CARD</a></li>
                            <li><i class="fa-brands fa-cc-visa" style="font-size:20px;"></i>&emsp;<a
                                    href="#">VISA
                                    CARD</a></li>
