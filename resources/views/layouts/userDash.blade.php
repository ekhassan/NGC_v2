...
<body>
    <div class="header">
        ...
        <div class="nav-scroller bg-white pb-5 shadow-sm mt-5">
            <nav class="nav ml-3
            ">
              <a class="dash nav-link border border-dark" href=""><i class="fa-solid fa-gauge"></i> Dashboard</a>
                <a class="dash dl nav-link" href="#"><i class="fa-solid fa-box-open"></i> Orders</a>
                <a class="dash ad nav-link" href="#"><i class="fa-solid fa-user"></i> Profile</a>
                <a class="dash ad nav-link" href="#"><i class="fa-solid fa-cart-shopping"></i> Cart</a>
                <a class="dash ch nav-link" href="#"><i class="fa-solid fa-clock-rotate-left"></i> Pending</a>               
